...
public class Basketball implements SportInterface {
            ...
            for (String line : resumeLines) {
                ...
                if (match.validatePlayer(values[1])) {
                    ...
                    switch (values[4]) {
                        case "G":
                            playerScore +=
                                    2 * Integer.parseInt(values[5]) +
                                    3 * Integer.parseInt(values[6]) +
                                    1 * Integer.parseInt(values[7]);
                            break;
                        case "F":
                            playerScore +=
                                    2 * Integer.parseInt(values[5]) +
                                    2 * Integer.parseInt(values[6]) +
                                    2 * Integer.parseInt(values[7]);
                            break;
                        case "C":
                            playerScore +=
                                    2 * Integer.parseInt(values[5]) +
                                    1 * Integer.parseInt(values[6]) +
                                    3 * Integer.parseInt(values[7]);
                            break;
                    }
